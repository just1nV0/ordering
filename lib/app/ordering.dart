...
//   final Widget Function(BuildContext context, ThemeData themeData, VoidCallback toggleDrawer) builder;

//   ThemeWrapper({required this.builder});
...
//   String selectedTheme = 'Fresh Green';

//   final Map<String, AppColorPalette> themePalettes = {
//     'Fresh Green': ColorThemes.freshGreen,
//     'Minimalist': ColorThemes.minimalist,
//     'Modern Blue': ColorThemes.modernBlue,
//     'Modern Purple': ColorThemes.modernPurple,
//     'Pastel Green': ColorThemes.pastelGreen,
//     'Pastel Blue': ColorThemes.pastelBlue,
//     'Modern Orange': ColorThemes.modernOrange,
//     'Pastel Pink': ColorThemes.pastelPink,
//     'Dark Green': ColorThemes.darkGreen,
//     'Dark Minimalist': ColorThemes.darkMinimalist,
//   };
...
//         appBarTheme: AppBarTheme(backgroundColor: darkPalette.primary),
//         textTheme: TextTheme(
...
//     final palette = themePalettes[selectedTheme]!;
//     return ThemeData(
//       primaryColor: palette.primary,
//       scaffoldBackgroundColor: palette.background,
//       appBarTheme: AppBarTheme(backgroundColor: palette.primary),
//       textTheme: TextTheme(
...
//     if (newTheme != null && themePalettes.containsKey(newTheme)) {
//       setState(() {
...
//                     isExpanded: true,
//                     onChanged: _setTheme,
//                     items: themePalettes.keys.map((String key) {
...
//                 Padding(
//                   padding: const EdgeInsets.all(16.0),
//                   child: Text("Theme selection disabled in dark mode"),
//                 ),
//             ],
//           ),
//         ),
